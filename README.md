...
- WS-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- WS-ui: main application module, development time
- WS-production: module that produces a production mode WAR for deployment
