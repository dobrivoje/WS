...
public class Tree_CustomerCRMCases extends CustomObjectTree<CrmCase> {
    ...
    public Tree_CustomerCRMCases(String caption, List customerCRMCases, boolean formAllowed) throws CustomTreeNodesEmptyException, NullPointerException {
        super(caption, customerCRMCases);
                    ...
                    if (formAllowed) {
                        ...
                        if (event.getItemId() instanceof CrmProcess) {
                            try {
                                ...
                                Tree_CustomerCRMCases ccct = new Tree_CustomerCRMCases("", crmProcess.getFK_IDCA().getFK_IDRSC().getFK_IDC(), formAllowed);
                                crudForm = new Form_CRMProcess(crmProcess, ccct, false, readOnly);
