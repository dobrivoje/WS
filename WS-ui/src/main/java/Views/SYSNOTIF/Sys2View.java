...
public final class Sys2View extends Panel implements View {
    public static final String VIEW_NAME = "Sys2View";
    ...
    private Component buildTopGrossingMovies() {
        Label topGrossingMoviesChart = new Label("topGrossingMoviesChart");
    ...
    private Component buildTop10TitlesByRevenue() {
        Component contentWrapper = createContentWrapper(new Label("buildTop10TitlesByRevenue"));
        contentWrapper.addStyleName("top10-revenue");
        return contentWrapper;
    }

    private Component buildPopularMovies() {
        return createContentWrapper(new Label("buildPopularMovies"));
    }
    ...
    private Component createContentWrapper(final Component content) {
        ...
        MenuItem panelOpts = tools.addItem("", FontAwesome.COG, null);
        panelOpts.addItem("Configure", new Command() {
            @Override
            public void menuSelected(final MenuItem selectedItem) {
        ...
        panelOpts.addItem("Close", new Command() {
            @Override
            public void menuSelected(final MenuItem selectedItem) {
                Notification.show("Not implemented in this demo");
            }
