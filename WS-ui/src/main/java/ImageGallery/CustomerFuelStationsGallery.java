 ...
 * @author dprtenjak
 */
public class CustomerFuelStationsGallery implements IImageGallery<Fuelstation> {

    private UI ui;
    private final IRefreshVisualContainer refreshVisualContainer;
    ...
    //<editor-fold defaultstate="collapsed" desc="createObjectImage">
    @Override
    public Image createObjectImage(Fuelstation f, float height, float width) {
            ...
            image.addClickListener(new MouseEvents.ClickListener() {
                ...
                public void click(MouseEvents.ClickEvent event) {
                    if (event.isDoubleClick()) {
                        openObjectGalleryWindow("Fuelstation - " + f.getName(), f);
                    }
                }
            });
        } catch (Exception e) {
    ...
    //<editor-fold defaultstate="collapsed" desc="createMainImage">
    @Override
    public VerticalLayout createMainImage(Fuelstation f) {
        return new VerticalLayout(createObjectImage(f, 200, 200));
    }
    //</editor-fold>
    
    //<editor-fold defaultstate="collapsed" desc="createImageGallery">
    @Override
    public VerticalLayout createImageGallery(Fuelstation f, boolean uploaderOnForm) {
        ...
        for (final DocImg di : getAllImages(f)) {
    ...
    //<editor-fold defaultstate="collapsed" desc="openObjectGalleryWindow">
    @Override
    public void openObjectGalleryWindow(String caption, Fuelstation f) {
    ...
    //<editor-fold defaultstate="collapsed" desc="getAllImages">
    @Override
    public List<DocImg> getAllImages(Fuelstation f) {
